 ...
 public class ParserSteps {
     ...
     public void theDirectObjectIs(String direct_object) throws Throwable {
         assertEquals(direct_object, command.getDirectObject());
     }

     @And("^the indirect object is \"([^\"]*)\"$")
     public void theIndirectObjectIs(String indirect_object) throws Throwable {
        assertEquals(indirect_object, command.getIndirectObject());
     }
